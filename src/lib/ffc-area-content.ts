...
function generateAboutAreaSection(domain: DomainConfig, areaName: string, areaSlug: string): AreaContentSection {
  ...
  return {
    ...
    content: `
      ...
      <p class="mb-4">Our deep familiarity with ${areaName} allows us to recommend the best spots and venues for your celebration. Whether you prefer your home, a private venue, or an outdoor setting, we know exactly how to create the perfect romantic atmosphere in this locality.</p>
      ...
      <ul class="list-disc list-inside space-y-2 mb-4">
        ...
        <li>Open-air venues with beautiful ambiance</li>
